...
model_1 = FullModel(num_classes=num_classes).to(device)
...
for epoch in range(epochs):
    ...
    torch.save(modelWrapper.teacher.state_dict(), f"progressive_{dataset}_weights.pth")
