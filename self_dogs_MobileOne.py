...
model_1 = mobileone(num_classes=num_classes, variant='s0').to(device)
#model_2 = mobileone(num_classes=num_classes, variant='s0').to(device)
...
for epoch in range(epochs):
    ...
    torch.save(modelWrapper.teacher.state_dict(), f"self_{dataset}__weights.pth")
