...
#This is the model with stem of 32 with expanded stages
...
class FullModel(nn.Module):
    def __init__(self, num_classes=1000, dropout=0.2):
        ...
        self.stage1 = ConvMixerStage(32, 64, patch_size=2, depth=8)
        self.stage2 = ConvMixerStage(64, 128, patch_size=2, depth=8)
        self.stage3 = ConvMixerStage(128, 256, patch_size=2, depth=7)
        self.stage4 = ConvMixerStage(256, 512, patch_size=2, depth=4)
