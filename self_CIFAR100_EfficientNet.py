...
model_1= efficientnet_b0(weights=None, num_classes=num_classes).to(device)   # EfficientNet_B0_2M
#model_2= efficientnet_b0(weights=None, num_classes=num_classes).to(device)   # EfficientNet_B0_2M
