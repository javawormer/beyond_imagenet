...
def get_cifar10_32_dataloaders(data_root, batch_size):
    cifar10_mean = (0.4914, 0.4822, 0.4465)
    cifar10_std = (0.2471, 0.2435, 0.2616)
...
if __name__ == "__main__":
    ...
    train_loader, val_loader = get_cifar10_dataloaders(data_root='../cifar-10-data/', batch_size=256)
