...
model_1= ghostnetv3(num_classes=num_classes, width=1.0).to(device)   # First branch
#model_2= ghostnetv3(num_classes=num_classes, width=1.0).to(device)   # First branch
...
for epoch in range(epochs):
    ...
    torch.save(modelWrapper.teacher.state_dict(), f"distill_{dataset}_weights.pth")
