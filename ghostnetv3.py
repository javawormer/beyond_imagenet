...
def ghostnetv3(**kwargs):
    ...
    return GhostNet(cfgs, num_classes=kwargs['num_classes'], width=kwargs['width'], dropout=0.2)
...
if __name__ == "__main__":
    ...
    model = ghostnetv3(num_classes=7, width=1.0).to(device)
    print("-------------------------My Ghost Model----------------------")
