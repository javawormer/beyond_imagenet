...
#This is the model with final channel to 512
...
class FullModel(nn.Module):
    def __init__(self, num_classes=1000, dropout=0.2):
        ...
        self.stage1 = ConvMixerStage(64, 128, patch_size=2, depth=4)
        self.stage2 = ConvMixerStage(128, 192, patch_size=2, depth=4)
        self.stage3 = ConvMixerStage(192, 256, patch_size=2, depth=4)
