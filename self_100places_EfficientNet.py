...
model_1= EfficientNet_B0_2M(num_classes=num_classes).to(device)   # EfficientNet_B0_2M
#model_2= EfficientNet_B0_2M(num_classes=num_classes).to(device)   # EfficientNet_B0_2M
...
#modelWrapper = SelfDistill_Cutmix_Model_Wrapper(model_1, model_2) #SelfDistill_Cutmix_Model_Wrapper
