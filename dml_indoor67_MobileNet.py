...
model_2 = mobilenet_v2(num_classes=num_classes, weights=None).to(device)   # First branch

#model_1= MobileNetV2(num_classes=num_classes).to(device)   # First branch
#model_2= MobileNetV2(num_classes=num_classes).to(device)   # First branch
