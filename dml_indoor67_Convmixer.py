...
#from stanford_dogs_loader import *
...
#train_loader, test_loader = get_dataloaders(data_root="data/dogs/images/Images",  batch_size=batch_size, cache_dir="cache")
...
modelWrapper = DML_Cutmix_Model_Wrapper(model_1, model_2) #SelfDistill_Cutmix_Model_Wrapper
...
for epoch in range(epochs):
    ...
    torch.save(modelWrapper.teacher.state_dict(), f"distill_{dataset}_convmixer_weights.pth")
